...
public class FicheroConAnimales {
	...
	public static void creaFicheroAnimales() {
		...
		Animal[] animales = {
				...
				new Animal(50, "Firulais", "Perro", "Chiuaua", "es un perro que lleva mucho tiempo aqui, y a pesar de ladrar mucho siempre le gusta dar y recibir cariño", (byte) 5, "12/02/2023", 1),
				new Animal(51, "Luna", "Gata", "Siamés", "es una gata muy curiosa y juguetona, le encanta perseguir cualquier cosa que se mueva", (byte) 1, "05/06/2025", 1),
				new Animal(52, "Rocky", "Perro", "Labrador", "es un perro muy energético y cariñoso, le encanta nadar y jugar con pelotas", (byte) 3, "18/03/2024", 1),
				new Animal(53, "Nala", "Gata", "Bengalí", "es una gata salvaje de carácter pero muy leal con quien se gana su confianza", (byte) 4, "22/07/2024", 1),
				new Animal(54, "Thor", "Perro", "Husky Siberiano", "es un perro muy activo que necesita mucho ejercicio, le encanta el frío y aullar por las noches", (byte) 2, "30/01/2025", 1),
				new Animal(55, "Mochi", "Conejo", "Mini Lop", "es un conejo muy tranquilo que pasa el día comiendo hierba y tumbado al sol", (byte) 1, "14/09/2025", 1),
				new Animal(56, "Simba", "Gato", "Maine Coon", "es un gato enorme y perezoso, se lleva bien con todos pero prefiere dormir a jugar", (byte) 6, "03/04/2022", 1),
				new Animal(57, "Bella", "Perra", "Golden Retriever", "es una perra dulce y obediente, perfecta para familias con niños pequeños", (byte) 3, "11/11/2024", 1),
				new Animal(58, "Pipa", "Loro", "Cacatúa", "es una cacatúa muy habladora que repite todo lo que escucha y le encanta el protagonismo", (byte) 7, "28/05/2021", 1),
				new Animal(59, "Pipa", "Loro", "Cacatúa", "es una cacatúa muy habladora que repite todo lo que escucha y le encanta el protagonismo", (byte) 7, "28/05/2021", 1),
				new Animal(60, "Pipa", "Loro", "Cacatúa", "es una cacatúa muy habladora que repite todo lo que escucha y le encanta el protagonismo", (byte) 7, "28/05/2021", 1),
				new Animal(61, "Pipa", "Loro", "Cacatúa", "es una cacatúa muy habladora que repite todo lo que escucha y le encanta el protagonismo", (byte) 7, "28/05/2021", 1),
