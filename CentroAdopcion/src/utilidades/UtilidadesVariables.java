...
public class UtilidadesVariables {
	...
	public static final float multiplicadorPanel,		//esta variable se va a utilizar para las resoluciones de los paneles
	...
	static {
		...
		BordeLinea = new LineBorder(TEXTO_OSCURO, 4);
		BORDEVACIO = new EmptyBorder(10, 10, 10, 10);
	}
	
	private static Color[] cargaColorFichero() {
		
		Color[] colores = ColoresGris;	//para que por defecto tenga el color gris
